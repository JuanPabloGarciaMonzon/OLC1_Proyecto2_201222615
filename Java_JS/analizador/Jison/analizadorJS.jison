...
.                     { 
                        ...
                        var error = new Error_Table.default(yytext,yylloc.first_line,yylloc.first_column, "lexico");
...
//-------------------------------------------------------------//
METODO
        :r_public r_void identificador '(' ')'  BLOQUE_METODO{$$ = new Metodo.default($3,$7, @1.first_line, @1.first_column); }
