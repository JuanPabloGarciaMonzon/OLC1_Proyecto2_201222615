...
function (_instruccion_1$Instru) {
  _inherits(Return, _instruccion_1$Instru);
  ...
  function Return(instrucciones, linea, columna) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Return).call(this, linea, columna));
  ...
  _createClass(Return, [{
    ...
    value: function traducir() {
      try {
        return "return ".concat(this.instrucciones.traducir(), ";\n");
      } catch (error) {
