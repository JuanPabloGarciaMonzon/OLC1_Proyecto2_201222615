...
function (_instruccion_1$Instru) {
  _inherits(Funcion_Main, _instruccion_1$Instru);

  function Funcion_Main(parametros, instrucciones, linea, columna) {
    var _this;

    _classCallCheck(this, Funcion_Main);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Funcion_Main).call(this, linea, columna));
    _this.instrucciones = instrucciones;
    _this.parametros = parametros;
    return _this;
  }

  _createClass(Funcion_Main, [{
    key: "getNodo",
