...
function (_instruccion_1$Instru) {
  _inherits(Parametros, _instruccion_1$Instru);

  function Parametros(tipo, identificador, linea, columna) {
    var _this;

    _classCallCheck(this, Parametros);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Parametros).call(this, linea, columna));
    _this.identificador = identificador;
    _this.tipo = tipo;
    return _this;
  }

  _createClass(Parametros, [{
    key: "getNodo",
