...
function (_instruccion_1$Instru) {
  _inherits(Contador, _instruccion_1$Instru);

  function Contador(operador, operando1, fila, columna) {
    var _this;

    _classCallCheck(this, Contador);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Contador).call(this, fila, columna));
