...
function (_instruccion_1$Instru) {
  _inherits(Aritmetica, _instruccion_1$Instru);

  function Aritmetica(operador, fila, columna, operando1, operando2) {
    var _this;

    _classCallCheck(this, Aritmetica);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Aritmetica).call(this, fila, columna));
    ...
    value: function traducir() {
      if (this.operandoU != null) {
        if (this.operador == "++" || this.operador == "--") {
          return "".concat(this.operandoU.traducir(), " ").concat(this.operador);
        } else {
