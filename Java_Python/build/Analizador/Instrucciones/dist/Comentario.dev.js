...
function (_instruccion_1$Instru) {
  _inherits(Comentario, _instruccion_1$Instru);

  function Comentario(comentario, fila, columna) {
    var _this;

    _classCallCheck(this, Comentario);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Comentario).call(this, fila, columna));
