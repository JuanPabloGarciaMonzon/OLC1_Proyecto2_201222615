...
function (_instruccion_1$Instru) {
  _inherits(Do_While, _instruccion_1$Instru);

  function Do_While(instrucciones, condicion, linea, columna) {
    var _this;

    _classCallCheck(this, Do_While);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Do_While).call(this, linea, columna));
    _this.condicion = condicion;
    _this.instrucciones = instrucciones;
    return _this;
  }

  _createClass(Do_While, [{
    key: "getNodo",
